...
EMAIL_USE_TLS = bool(os.environ.get("DJANGO_EMAIL_USE_TLS", default=1))

EMAIL_USE_SSL = bool(os.environ.get("DJANGO_EMAIL_USE_SSL", default=0))
...
TIME_ZONE = os.environ.get("WAGGYLABS_TIME_ZONE", default="UTC")
...
WAGTAIL_PASSWORD_RESET_ENABLED = bool(os.environ.get("WAGTAIL_PASSWORD_RESET_ENABLED", default=1))

# Passwords can be changed
WAGTAIL_PASSWORD_MANAGEMENT_ENABLED = bool(os.environ.get("WAGTAIL_PASSWORD_MANAGEMENT_ENABLED", default=1))
